...
function DatabaseSection() {
  ...
  return (
    <section className="section-band">
      <SectionHeader icon={Settings} title="数据库连接" description="连接测试和初始化成功后写入本地私有配置，重启 UnionC 后生效。" />
      <div className="content-grid settings-grid">
        <form
      ...
      <div className="database-notices">
        ...
        {saveMutation.isSuccess && <InlineNotice tone="warn" text="连接测试通过，配置已保存；重启 UnionC 后生效。" />}
      </div>
    </section>
  );
}
  ...
  return (
    <section className="view-stack">
      ...
      <section className="section-band">
        ...
        />
        <div className="content-grid settings-grid">
          <SettingItem label="配置" value="unionc/data/unionc-config.json" />
          <SettingItem label="日光" value="unionc/data/sunshine" />
          <SettingItem label="月光" value="unionc/data/moonlight" />
        </div>
      </section>
    </section>
  );
