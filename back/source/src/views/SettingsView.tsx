  ...
  return (
    <section className="view-stack">
      ...
      <section className="section-band">
        ...
        />
        <div className="content-grid settings-grid">
          <SettingItem label="配置" value="union/data/union-config.json" />
          <SettingItem label="文件" value="ram/data/files" />
          <SettingItem label="内容" value="blog/data/content" />
          <SettingItem label="资源" value="blog/data/files" />
          <SettingItem label="日光" value="union/data/sunshine" />
          <SettingItem label="月光" value="union/data/moonlight" />
        </div>
      </section>
    </section>
  );
