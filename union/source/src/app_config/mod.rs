...
pub const LOCAL_CONFIG_PATH: &str = "union/data/union-config.json";
...
impl Default for SunshineHostConfig {
    fn default() -> Self {
        Self {
            ...
            log_path: PathBuf::from("union/data/sunshine/logs/sunshine.log"),
...
impl Default for PathSettings {
    fn default() -> Self {
        Self {
            data_dir: PathBuf::from("ram/data/files"),
            public_dir: PathBuf::from("ram/data/files/public"),
            inbox_dir: PathBuf::from("ram/data/files/inbox"),
            private_dir: PathBuf::from("ram/data/files/private"),
            blog_export_dir: PathBuf::from("blog/data/content"),
            blog_assets_dir: PathBuf::from("blog/data/files"),
            media_dir: PathBuf::from("ram/data/files/media"),
            sunshine_dir: PathBuf::from("union/data/sunshine"),
            moonlight_dir: PathBuf::from("union/data/moonlight"),
            logs_dir: PathBuf::from("ram/data/logs"),
        }
    }
}
...
impl Default for RamSettings {
    fn default() -> Self {
        Self {
            ...
            tls_key: None,
            extra_args: Vec::new(),
            log_path: PathBuf::from("ram/data/logs/ram.log"),
            process_log_path: PathBuf::from("ram/data/logs/ram-process.log"),
        }
    }
}
...
impl Default for BlogSettings {
    fn default() -> Self {
        Self {
            work_dir: PathBuf::from("blog/source"),
            build_command: "npm".to_string(),
            build_args: vec!["run".to_string(), "build".to_string()],
            build_log_dir: PathBuf::from("blog/data/logs"),
        }
    }
}
